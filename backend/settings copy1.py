...
EMAIL_TOKEN_EXPIRATION = config('EMAIL_TOKEN_EXPIRATION', default=120, cast=int)

# Pour que les décimales ressortent en chaînes ("25000.00", "95.500"), ajoute :
REST_FRAMEWORK = {"COERCE_DECIMAL_TO_STRING": True}
...
FRONTEND_BASE_URL = 'https://rio-gold.com'
