    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('purete', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='purete_marques', to='store.purete')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('categorie', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='categorie_modeles', to='store.categorie')),
                ('modele', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='modele_categories', to='store.modele')),
            ],
            options={
