...
urlpatterns = [
    ...
    path("stocks/assign/vendor/",stock_views.MagasinToVendorAssignmentView.as_view(),name="magasin-to-vendor-assignment",),
    ...
    path("staff/creer-admin",staff_views.PromoteAdminView.as_view(),name="create-admin",),
    ...
    path("compte-depot/soldes/export-excel/",compte_depot_views.ExportCompteDepotSoldesExcelAPIView.as_view(),name="compte-depot-soldes-export-excel",),
    # dashboard
