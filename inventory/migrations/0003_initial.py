...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddIndex(
            model_name='inventorymovement',
            index=models.Index(fields=['sale_out_key'], name='inventory_i_sale_ou_5d11e9_idx'),
        ),
        migrations.AddIndex(
            model_name='inventorymovement',
        ...
        migrations.AddConstraint(
            model_name='inventorymovement',
            constraint=models.CheckConstraint(check=models.Q(models.Q(('movement_type', 'VENDOR_ASSIGN'), _negated=True), ('vendor__isnull', False), _connector='OR'), name='ck_vendor_assign_requires_vendor'),
        ),
        migrations.AddConstraint(
            model_name='inventorymovement',
