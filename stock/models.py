...
#     # quantité donnée au vendeur
#     quantite_allouee = models.PositiveIntegerField(default=0)

#     # quantité vendue par le vendeur
...
#             # un seul stock par produit / vendeur / bijouterie
#             models.UniqueConstraint(
#                 fields=["produit_line", "vendor", "bijouterie"],
#                 name="uq_vendorstock_produit_vendor_bijouterie",
#             ),

#             # sécurité : vendu <= alloué
#             models.CheckConstraint(
#                 check=Q(quantite_allouee__gte=0)
#                 & Q(quantite_vendue__gte=0)
#                 & Q(quantite_vendue__lte=F("quantite_allouee")),
#                 name="ck_vendorstock_quantites_valides",
#             ),
#         ]
...
#     def __str__(self):
#         return f"{self.vendor} - {self.produit_line} ({self.en_stock})"
...
#         """
#         Stock disponible chez le vendeur
#         """
#         return max(0, self.quantite_allouee - self.quantite_vendue)
...
#             if getattr(self.vendor, "bijouterie_id", None) != self.bijouterie_id:
#                 raise ValidationError({
