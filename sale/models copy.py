...
#     sous_total_prix_vente_ht = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
#     total_ligne = models.DecimalField(max_digits=14, decimal_places=2, default=Decimal("0.00"))
...
#         total = self.sous_total_prix_vente_ht - remise_v + autres_v
#         if total < ZERO:
#             total = ZERO

#         self.total_ligne = total.quantize(TWOPLACES, rounding=ROUND_HALF_UP)
...
#     )
#     # hashage pour intégrité de la facture (hash de son contenu + éléments clés)
...
#     # securise la facture pour éviter les modifications après signature 
#     # (la facture devient "verrouillée" après signature)
#     is_locked = models.BooleanField(default=False)
#     locked_at = models.DateTimeField(null=True, blank=True)
    
#     commande_client = models.ForeignKey("order.CommandeClient", 
#                                         on_delete=models.SET_NULL, null=True, 
#                                         blank=True, related_name="factures",)
...
#             taux = self.taux_tva or Decimal("0.00")
#         else:
#             taux = Decimal("0.00")

#         self.taux_tva = taux

#         self.montant_tva = (ht * taux / Decimal("100")).quantize(
#             Decimal("0.01"),
