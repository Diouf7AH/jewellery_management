...
#             CheckConstraint(check=Q(solde_avant__gte=0), name="ck_transaction_solde_avant_gte_0"),
#             CheckConstraint(check=Q(solde_apres__gte=0), name="ck_transaction_solde_apres_gte_0"),
#         ]
#         indexes = [
