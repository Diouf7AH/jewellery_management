...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='achat',
            name='fournisseur',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='achats', related_query_name='achat', to='purchase.fournisseur'),
        ),
        migrations.AddField(
            model_name='lot',
            name='achat',
        ...
        migrations.AddField(
            ...
            name='lot',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='lignes', to='purchase.lot'),
        ),
        migrations.AddField(
            model_name='produitline',
            name='produit',
        ...
        migrations.AddConstraint(
            model_name='produitline',
            constraint=models.CheckConstraint(condition=models.Q(('quantite__gte', 1)), name='ck_pl_qty_gte1'),
        ),
        migrations.AddConstraint(
            model_name='produitline',
            constraint=models.CheckConstraint(condition=models.Q(('prix_achat_gramme__gte', 0)), name='produit_line_prix_achat_gte_0'),
        ),
        migrations.AddConstraint(
            model_name='produitline',
            constraint=models.UniqueConstraint(fields=('lot', 'produit'), name='uniq_produit_per_lot'),
        ),
    ]
